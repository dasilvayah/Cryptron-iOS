...
enum S {
    ...
    enum Send {
        ...
        static let cameraUnavailableTitle = NSLocalizedString("Send.cameraUnavailableTitle", value:"Cryptron is not allowed to access the camera", comment: "Camera not allowed alert title")
    ...
    enum JailbreakWarnings {
        ...
        static let messageWithBalance = NSLocalizedString("JailbreakWarnings.messageWithBalance", value:"DEVICE SECURITY COMPROMISED\n Any 'jailbreak' app can access Cryptron's keychain data and steal your bitcoin! Wipe this wallet immediately and restore on a secure device.", comment: "Jailbreak warning message")
    ...
    enum UnlockScreen {
        ...
        static let touchIdPrompt = NSLocalizedString("UnlockScreen.touchIdPrompt", value:"Unlock your Cryptron.", comment: "TouchID/FaceID prompt text")
    ...
    enum Transaction {
        ...
        static let tokenTransfer = NSLocalizedString("Transaction.tokenTransfer", value:"Fee for token transfer: %1$@", comment: "Fee for token transfer: Cryptron")
    }
    ...
    enum SecurityCenter {
        enum Cells {
            ...
            static let pinDescription = NSLocalizedString("SecurityCenter.pinDescription", value:"Protects your Cryptron from unauthorized users.", comment: "PIN button description")
            static let touchIdTitle = NSLocalizedString("SecurityCenter.touchIdTitle", value:"Touch ID", comment: "Touch ID button title")
            static let touchIdDescription = NSLocalizedString("SecurityCenter.touchIdDescription", value:"Conveniently unlock your Cryptron and send money up to a set limit.", comment: "Touch ID/FaceID button description")
    ...
    enum UpdatePin {
        ...
        static let createInstruction = NSLocalizedString("UpdatePin.createInstruction", value:"Your PIN will be used to unlock your Cryptron and send money.", comment: "PIN creation info.")
    ...
    enum RecoverWallet {
        ...
        static let intro = NSLocalizedString("RecoverWallet.intro", value:"Recover your Cryptron with your paper key.", comment: "Recover wallet intro")
    ...
    enum AccountHeader {
        static let defaultWalletName = NSLocalizedString("AccountHeader.defaultWalletName", value:"My Cryptron", comment: "Default wallet name")
    ...
    enum TouchIdSettings {
        ...
        static let explanatoryText = NSLocalizedString("TouchIdSettings.explanatoryText", value: "Use Touch ID to unlock your Cryptron app and send money.", comment: "Explanation for Touch ID settings")
        static let switchLabel = NSLocalizedString("TouchIdSettings.switchLabel", value:"Enable Touch ID for Cryptron", comment: "Touch id switch label.")
        ...
        static let unlockTitleText = NSLocalizedString("TouchIdSettings.unlockTitleText", value: "Enable Touch ID to unlock Cryptron", comment: "Touch ID unlock toggle title")
    }
    
    enum FaceIDSettings {
        static let title = NSLocalizedString("FaceIDSettings.title", value:"Face ID", comment: "Face ID settings view title")
        static let explanatoryText = NSLocalizedString("FaceIDSettings.explanatoryText", value: "Use Face ID to unlock your Cryptron app and send money.", comment: "Explanation for Face ID settings")
        static let switchLabel = NSLocalizedString("FaceIDSettings.switchLabel", value:"Enable Face ID for Cryptron", comment: "Face id switch label.")
        ...
        static let unlockTitleText = NSLocalizedString("FaceIDSettings.unlockTitleText", value: "Enable Face ID to unlock Cryptron", comment: "Face ID unlock toggle title")
    }
    ...
    enum Settings {
        ...
        static let enjoying = NSLocalizedString("Settings.enjoying", value: "Are you enjoying Cryptron?", comment: "Are you enjoying Cryptron alert message body")
    ...
    enum About {
        ...
        static let walletID = NSLocalizedString("About.walletID", value:"Cryptron Rewards ID", comment: "About screen wallet ID label")
        static let footer = NSLocalizedString("About.footer", value:"Made by the global Cryptron team. Version %1$@ Build %2$@", comment: "About screen footer")
    }
    ...
    enum PushNotifications {
        ...
        static let enabledBody = NSLocalizedString("PushNotifications.enabledBody", value:"You’re receiving special offers and updates from Cryptron.", comment: "Push notifications settings view body when the toggle is enabled.")
        static let disabledBody = NSLocalizedString("PushNotifications.disabledBody", value:"Turn on notifications to receive special offers and updates from Cryptron.", comment: "Push notifications settings view body when the toggle is disabled.")
        static let enableInstructions = NSLocalizedString("PushNotifications.enableInstructions", value: "Looks like notifications are turned off. Please go to Settings to enable notifications from Cryptron.", comment: "Instructions for enabling push notifications in Settings")
    ...
    enum ReScan {
        ...
        static let body2 = NSLocalizedString("ReScan.body2", value:"If a transaction shows as completed on the network but not in your Cryptron.", comment: "Syncing explanation")
    ...
    enum ShareData {
        ...
        static let body = NSLocalizedString("ShareData.body", value:"Help improve Cryptron by sharing your anonymous data with us. This does not include any financial information. We respect your financial privacy.", comment: "Share data view body")
    ...
    enum OnboardingScreen {
        ...
        static let pageTwoTitle = NSLocalizedString("OnboardingPageTwo.title", value: "Join millions of people around the world who trust Cryptron.", comment: "Title displayed on the second page of the onboarding flow.")
        static let pageTwoSubtitle = NSLocalizedString("OnboardingPageTwo.subtitle", value: "Join the 1.5 million people around the world who trust Cryptron.", comment: "Subtitle displayed on the second page of the onboarding flow.")
        ...
        static let pageThreeSubtitle = NSLocalizedString("OnboardingPageThree.subtitle", value: "Invest and diversify with Cryptron, easily and securely.", comment: "Subtitle displayed on the third page of the onboarding flow.")   
    ...
    enum Watch {
        static let noWalletWarning = NSLocalizedString("Watch.noWalletWarning", value: "Open the Cryptron iPhone app to set up your wallet.", comment: "'No wallet' warning for watch app")
    }
    ...
    enum Prompts {
        ...
        enum UpgradePin {
            ...
            static let body = NSLocalizedString("Prompts.UpgradePin.body", value: "Cryptron has upgraded to using a 6-digit PIN. Tap Continue to upgrade.", comment: "Upgrade PIN prompt body.")
        }
        enum NoPasscode {
    ...
    enum LocationPlugin {
        ...
        static let notAuthorized = NSLocalizedString("LocationPlugin.notAuthorized", value: "Cryptron does not have permission to access location services.", comment: "No permissions for location services")
    }
    ...
    enum Import {
        ...
        static let rightCaption = NSLocalizedString("Import.rightCaption", value: "Your Cryptron Wallet", comment: "Caption for graphics")
        static let importMessage = NSLocalizedString("Import.message", value: "Importing a wallet transfers all the money from your other wallet into your Cryptron wallet using a single transaction.", comment: "Import wallet intro screen message")
    ...
    enum WipeWallet {
        ...
        static let startMessage = NSLocalizedString("WipeWallet.startMessage", value: "Starting or recovering another wallet allows you to access and manage a different Cryptron wallet on this device.", comment: "Start wipe wallet view message")
    ...
    enum Welcome {
        static let title = NSLocalizedString("Welcome.title", value: "Cryptron now supports Ethereum!", comment: "Welcome view title")
    ...
    enum RewardsView {
        ...
        static let expandedTitle = NSLocalizedString("RewardsView.expandedTitle", value: "Introducing Cryptron\nRewards.", comment: "Rewards view expanded title")
    ...
    enum RecoverKeyFlow {
        ...
        static let storeSecurelyRecommendation = NSLocalizedString("RecoveryKeyFlow.storeSecurelyRecommendation",
                                                                   value: "Store your key in a secure location. This is the only way to recover your wallet. Cryptron does not keep a copy.",
        ...
        static let securityAssurance = NSLocalizedString("RecoveryKeyFlow.securityAssurance",
                                                         ...
                                                         comment: "Assures the user that Cryptron will keep the user's funds secure.")
        ...
        static let successSubheading = NSLocalizedString("RecoveryKeyFlow.successSubheading",
                                                         value: "You're all set to deposit, trade, and buy crypto from your Cryptron wallet.",
